---
title: Como gerencio meu fluxo de trabalho
date: 2016-08-04 11:37
category: Produtividade
tags: produtividade
summary: Nós, contadores somos seres naturalmente atarefados. São tantas obrigações que temos que cumprir, relatórios para preencher, ofícios e e-mails para responder. Por isso não é incomum desejar que o dia tenha mais que vinte e quatro horas e o mês mais que trinta (ou trinta e um) dias.
---
...
As técnicas de priorização ajudam a priorizar as tarefas e ordená-las antes da execução. Eu utilizo a [Tríade do Tempo](http://lpprodutividade.com.br/blog/triade-do-tempo/).

Ela é uma simplificação da [Matriz de Eisenhower](http://lpprodutividade.com.br/blog/como-priorizar/), que por si só já é uma técnica de priorização fantástica, seja pela simplicidade, seja pelos resultados que dá. No início era essa técnica que eu utilizava.

A Tríade do Tempo (TT) se baseia na classificação das tarefas em Importante, Urgente e Circunstancial. Sobre ela, resumidamente, permito-me reproduzir parte do texto [A TRÍADE DO TEMPO: RASTREANDO SUA PRODUTIVIDADE E OTIMIZANDO SEUS RESULTADOS](http://lpprodutividade.com.br/blog/triade-do-tempo/) publicado no [LP Produtividade](http://lpprodutividade.com.br/blog/triade-do-tempo/):
...
Adicionalmente, para escolher as tarefas que eu vou fazer no dia, eu utilizo a [Método Ivy Lee](http://lpprodutividade.com.br/blog/ivy-lee/), que se resume em cinco passos conforme descrito no [LP Produtividade](http://lpprodutividade.com.br/blog/ivy-lee/):
...
Particularmente eu utilizo uma mescla da técnica de passos do [GTD](http://www.wiseaction.pt/recursos/recursos-gtd%C2%AE/gtd-em-20-minutos/), [ZTD](http://efetividade.net/2011/11/ztd-um-jeito-zen-e-minimalista-de-buscar-a-produtividade-pessoal.html), [Agile Result](http://lpprodutividade.com.br/blog/agile-results/) e [Kanbam Pessoal](http://lpprodutividade.com.br/blog/kanbam-pessoal/), que também veremos à seguir, quando tratarmos das técnicas de fluxo de trabalho.
...
Eu possuo seis [caixas para correspondências](http://www.acrimet.com.br/site/pt/produto/14/Caixa-para-Correspondencia-Modular) que utilizo para separar cada etapa do fluxo de trabalho (Kanbam Pessoal):
...
Por fim, o último conjunto de técnicas que uso são as relativas à execução das tarefas propriamente ditas. As técnicas que utilizo foram adaptadas do [Método Pomodoro](https://pt.wikipedia.org/wiki/T%C3%A9cnica_pomodoro) e do [Ivy Lee](http://lpprodutividade.com.br/blog/ivy-lee/).
...
Outras coisas que uso e que gostaria de compartilhar se refere ao controle de prazos. Particularmente nunca consegui usar agenda, em papel ou digital, então os prazos eu controlo via lembretes do [Inbox do Google](https://inbox.google.com/).

Para quem utiliza o Inbox do Google, ele tem uma funcionalidade (que também é integrada ao [Google Keep](https://keep.google.com/)) que é a de cadastrar lembretes. Você cadastra o lembrete para uma data/horário específico e ele aparecerá na caixa de entrada do Inbox no momento agendado. Além disso, os lembretes podem ser adiados sempre que necessário.
