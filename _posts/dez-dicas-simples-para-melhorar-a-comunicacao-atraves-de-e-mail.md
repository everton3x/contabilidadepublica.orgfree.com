---
title: Dez dicas simples para melhorar a comunicação através de e-mail
date: 2016-12-08
category: Produtividade
tags: comunicação, e-mail
---
Este é um resumo das dicas apresentadas pelo blog [LP Produtividade](http://lpprodutividade.com.br/) sobre [10 dicas simples para otimizar a sua comunicação via e-mail](http://lpprodutividade.com.br/blog/dicas-comunicacao-para-e-mail/).

## 1. Preste atenção ao escolher o “Assunto”

O assunto do e-mail é o primeiro contato do leitor com o conteúdo da mensagem eletrônica.

Utilize palavras-chaves e seja conciso, como por exemplo:

“Lembrete de Reunião – 14/12/16 (Quarta-feira), às 15 horas”

"Urgente - Confirmar pagamento - fatura de dezembro"

## 2. Especifique a resposta que você deseja

Indique ou especifique a resposta desejada ao e-mail. Se precisar de dados ou informações específicas, liste-as. Se tiver um prazo para resposta, indique. Se precisar de um formato específico de resposta, envie como anexo, ou indique isso.

Não esqueça de colocar no e-mail as suas informações de contato para que a resposta chegue até você.
...
Coloque-se na posição do leitor e veja como se sentiria caso recebesse um e-mail como o que você está escrevendo. Caso suas intenções possam ser mal interpretadas, procure encontrar uma maneira melhor de se comunicar.

Evite letras maiúsculas e pontos de exclamação e interrogação em excesso. Cuidado também com as cores, tipo e tamanho da fonte.

Informações importantes devem ser realçadas em negrito apenas.

## 8. Releia antes de enviar

Básico para qualquer documento.
...
e-mails não são a melhor forma de trabalhar com documentos que requerem colaboração.

Este é apenas um resumo do texto, o qual recomendo a leitura no link do início deste post.
