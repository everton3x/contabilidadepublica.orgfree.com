---
title: Matriz GUT para o PIPCP (Plano de Implantação dos Procedimentos Contábeis Patrimoniais)
date: 2016-11-24
...
Para maiores detalhes, leia este texto: [PIPCP: Plano de Implantação dos Procedimentos Contábeis Patrimoniais]({filename}2016-04-04-pipcp-plano-de-implantacao-dos-procedimentos-contabeis-patrimoniais.md).

As premissas utilizadas para esta matriz são:

- Lista de Procedimentos considerados são os relatados neste texto: [Usando matriz GUT na implantação dos Procedimentos Contábeis Patrimoniais]({filename}2016-10-29-usando-matriz-gut-na-implantacao-dos-procedimentos-contabeis-patrimoniais.md)
...
[Planilha do Excel com a Matriz GUT]({filename}/files/pipcp-gut.xlsx)
